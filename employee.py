...
class Employee:
    def __init__(self, root):
        ...
        # logo
        img_logo = Image.open(os.path.join(BASE_DIR, "images", "gg.png"))
        ...
        # 1st image
        img1 = Image.open(os.path.join(BASE_DIR, "images", "kk.png"))
        ...
        # 2nd image
        img_2 = Image.open(os.path.join(BASE_DIR, "images", "pp.png"))
        ...
        # 3rd image
        img_3 = Image.open(os.path.join(BASE_DIR, "images", "qq.png"))
        ...
        combo_dep = ttk.Combobox(upper_frame, textvariable=self.var_dep, font=('times arial', 12, 'bold'), width=17,
                                 state='readonly')
        ...
        # mask image
        img_mask = Image.open(os.path.join(BASE_DIR, "images", "oo.png"))
        ...
        btn_clear = Button(button_frame, text="Clear", command=self.reset_data, font=("arial", 15, "bold"), width=13,
                           bg='blue', fg='white')
        ...
        btn_search = Button(search_frame, text="search", command=self.search_data, font=("arial", 11, "bold"), width=14,
                            bg="blue", fg="white")
        ...
        # search image
        img_logo_mask = Image.open(os.path.join(BASE_DIR, "images", "aa.png"))
        ...
        self.employee_table = ttk.Treeview(table_frame, column=("dep", "name", "degi", "email", "adress", "married",
    ...
    def add_data(self):
        if self.var_dep.get() == "" or self.var_email.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host='localhost', username='root', password='pavankumar@123', database='second')
        ...
        if self.var_dep.get() == "" or self.var_email.get() == "":
            ...
            try:
                ...
                if update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        'update employee2 set Department=%s,Name=%s,Designition=%s,Email=%s,Adress=%s,Married_status=%s,DOB=%s,DOJ=%s,id_proof_type=%s,Gender=%s,Phone=%s,Country=%s,Salary=%s where id_proof=%s', (
                            self.var_dep.get(),
                            self.var_name.get(),
                            self.var_designition.get(),
                            self.var_email.get(),
    ...
    def search_data(self):
        if self.var_com_search.get() == '' or self.var_search.get() == '':
            ...
            try:
                conn = mysql.connector.connect(host='localhost', username='root', password='pavankumar@123', database='second')
                my_cursor = conn.cursor()
                my_cursor.execute('select * from employee2 where ' + str(
